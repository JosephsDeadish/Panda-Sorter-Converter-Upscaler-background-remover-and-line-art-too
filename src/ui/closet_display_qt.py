...
class ClosetDisplayWidget(QWidget):
    ...
    def _setup_ui(self):
        ...
        self._set_tooltip(self._cat_combo, 'closet_all_clothing')
        self._set_tooltip(self._cat_combo, 'closet_shirts')
        self._set_tooltip(self._cat_combo, 'closet_pants')
        self._set_tooltip(self._cat_combo, 'closet_jackets')
        self._set_tooltip(self._cat_combo, 'closet_dresses')
        self._set_tooltip(self._cat_combo, 'closet_full_outfits')
        ...
        self._set_tooltip(self._search_input, 'closet_header')
