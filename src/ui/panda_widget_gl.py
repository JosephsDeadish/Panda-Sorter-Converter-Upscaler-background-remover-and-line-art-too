"""
panda_widget_gl.py - Stub replacement for the OpenGL floating overlay panda widget.

This stub replaces the original 5780-line OpenGL animated companion panda overlay.
...
class PandaOpenGLWidget(_Base):
    """
    Stub for the OpenGL panda companion overlay widget (issue #207).

    The original implementation rendered an animated 3-D panda floating over
    the application UI using OpenGL.  This stub preserves the public interface
